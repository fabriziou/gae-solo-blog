...
public final class Preference {
    ...
    public static final class Default {
         ...
         * Default blog title.
         */
        public static final String DEFAULT_BLOG_TITLE = "GAE Blog 示例";
         ...
         */
        public static final String DEFAULT_SKIN_DIR_NAME = "community";
         ...
         */
        public static final String DEFAULT_META_KEYWORDS = "Java 博客,GAE,blog";
