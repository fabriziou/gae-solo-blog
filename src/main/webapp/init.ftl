...
<html>
    <head>
        ...
        <meta name="keywords" content="GAE 博客,GAE blog,init" />
                ...
                <div class="content" id="main">
                    <div class="logo">
                        <a href="${servePath}" target="_blank">
                            <img border="0" width="153" height="56" alt="B3log" title="B3log" src="${staticServePath}/images/appengine.gif"/>
                        </a>
                    </div>
                    <div class="main">
                        <h2>
